(function ($) {
    ...
    var PosttElements_SwupHandler = function ( ) {
        ...
        swup.on('contentReplaced', function () {
            ...
            madxartworkFrontend.elementsHandler.initHandlers();
            swup.options.elements.forEach((selector) => {
                

                //console.log(selector);
                // load scripts for all elements with 'selector'
                var element_el = $(selector).find('.madxartwork-element');
    ...
    $(window).on('madxartwork/frontend/init', function () {
        ...
        //
        //
        //console.log(madxartworkFrontendConfig.settings.dynamicooo);
        ...
        /*if (madxartworkFrontend.isEditMode()) {
            ...
            //madxartwork.settings.dynamicooo.addChangeCallback('enable_swup', handleSwup);
    ...
    //
    if( typeof madxartworkFrontendConfig.settings.dynamicooo !== 'undefined' ) {
