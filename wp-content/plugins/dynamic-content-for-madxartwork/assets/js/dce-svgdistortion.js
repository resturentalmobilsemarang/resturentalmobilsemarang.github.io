(function ($) {
    var WidgetElements_SvgDistortionHandler = function ($scope, $) {
      ...
      if(madxartworkFrontend.isEditMode()){
        ...
        $('.madxartwork-element[data-id='+id_scope+'] svg, .'+elementSettings.id_svg_class+' a').off('mouseenter');
        $('.madxartwork-element[data-id='+id_scope+'] svg, .'+elementSettings.id_svg_class+' a').off('mouseleave');
        $('.madxartwork-element[data-id='+id_scope+'] svg, .'+elementSettings.id_svg_class+' a').off('touchstart');
        $('.madxartwork-element[data-id='+id_scope+'] svg, .'+elementSettings.id_svg_class+' a').off('touchend');
      }
      ...
      if(elementSettings.svg_trigger == 'animation'){
        ...
        // $('#dce-svg-'+id_scope)
        $('.madxartwork-element[data-id='+id_scope+'] svg, .'+elementSettings.id_svg_class+' a').on('mouseenter', mouseenterFn);
        $('.madxartwork-element[data-id='+id_scope+'] svg, .'+elementSettings.id_svg_class+' a').on('mouseleave', mouseleaveFn);
        $('.madxartwork-element[data-id='+id_scope+'] svg, .'+elementSettings.id_svg_class+' a').on('touchstart', mouseenterFn);
        $('.madxartwork-element[data-id='+id_scope+'] svg, .'+elementSettings.id_svg_class+' a').on('touchend', mouseleaveFn);
