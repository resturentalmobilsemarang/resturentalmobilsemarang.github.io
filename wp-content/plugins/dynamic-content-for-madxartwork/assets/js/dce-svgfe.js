(function ($) {
    var WidgetElements_SvgFilterEffectsHandler = function ($scope, $) {
          ...
          /*if(elementSettings.svg_trigger == 'animation'){
            ...
            // $('#dce-svg-'+id_scope)
            $('.madxartwork-element[data-id='+id_scope+'] svg').on('mouseenter', mouseenterFn);
            $('.madxartwork-element[data-id='+id_scope+'] svg').on('mouseleave', mouseleaveFn);
            $('.madxartwork-element[data-id='+id_scope+'] svg').on('touchstart', mouseenterFn);
            $('.madxartwork-element[data-id='+id_scope+'] svg').on('touchend', mouseleaveFn);
    ...
    $(window).on('madxartwork/frontend/init', function () {
        madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-filtereffects.default', WidgetElements_SvgFilterEffectsHandler);
    });
})(jQuery);
