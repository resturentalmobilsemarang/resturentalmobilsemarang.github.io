    ...
    $(document).on('ready', function () {
        ...
        if (typeof madxartworkFrontendConfig.settings.page !== 'undefined') {
            ...
            if (settings_page) {
                ...
                //console.log(madxartworkFrontendConfig.post.id);
                if (is_enable_scrollEffects && is_enable_dceScrolling) {
                    //
                    //alert('lax: '.madxartworkFrontendConfig.post.id);
                    setTimeout(function () {
                ...
                if (madxartworkFrontend.isEditMode()) {
                    ...
                    //madxartwork.settings.page.addChangeCallback( 'enable_dceScrolling', handleScrollEffects );
