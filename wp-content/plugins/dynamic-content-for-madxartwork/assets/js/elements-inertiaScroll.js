( function( $ ) {
	...
	$( document ).on( 'ready', function() {
		...
		if ( madxartworkFrontend.isEditMode() ){
			...
			madxartwork.settings.page.addChangeCallback( 'directionScroll', handleInertiaScroll );
			...
			//madxartwork.settings.page.addChangeCallback( 'enable_dceScrolling', handleInertiaScroll );
		} 
