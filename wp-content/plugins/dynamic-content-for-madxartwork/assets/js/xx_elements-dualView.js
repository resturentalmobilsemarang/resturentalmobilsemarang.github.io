(function ($) {
            ...
            openItem(item) {
                ...
                TweenMax.to(item.DOM.tilt.img, 1.2, {
                    ...
                    onComplete: () => {
                        ...
                        //$(".madxartwork-element-"+dualViewId).prependTo("body");
    ...
    $(window).on('madxartwork/frontend/init', function () {
        madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-dualView.default', WidgetElements_DualViewHandler);
    });
})(jQuery);
