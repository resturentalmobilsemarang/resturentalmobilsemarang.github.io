(function ($) {
    ...
    var WidgetElements_AnimateTextHandler = function ($scope, $) {
        ...
        var changeAndSplittingText = function($i, $ii){
            ...
            target.removeClass('madxartwork-repeater-item-'+ids[$ii]).addClass('madxartwork-repeater-item-'+ids[$i]);
    ...
    $(window).on('madxartwork/frontend/init', function () {
        //alert('animate text');
        madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-animateText.default', WidgetElements_AnimateTextHandler);
    });
})(jQuery);