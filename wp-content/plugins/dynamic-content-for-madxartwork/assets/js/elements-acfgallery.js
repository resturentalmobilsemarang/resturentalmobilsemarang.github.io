    ...
    var WidgetDyncontel_ACFGalleryHandler = function ($scope, $) {
        ...
        if (elementSettingsACFGallery.gallery_type == 'masonry') {
            ...
            */
            ...
            var $size_d = '';
            //alert( $(window).width() < 769 + "   " + $('madxartwork-preview-responsive-wrapper').innerWidth());
            /*if( $(window).width() < 769 || $('madxartwork-preview-responsive-wrapper').innerWidth() < 992 ){
             $size_d = elementSettingsACFGallery.size_honeycombs_tablet;
             }else if( $(window).width() < 480 || $('madxartwork-preview-responsive-wrapper').innerWidth() < 480 ){
