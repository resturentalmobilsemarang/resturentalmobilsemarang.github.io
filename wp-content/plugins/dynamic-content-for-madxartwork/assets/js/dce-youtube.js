...
*/    
        ...
        */
        ...
        function onPlayerReady(event) {
            ...
            var elementSettings = jQuery('#'+ytid).closest('.madxartwork-widget-dce-ytvideo').data('settings') || {};
...
/*    
    ...
    $( window ).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction( 'frontend/element_ready/dce-ytvideo.default', WidgetElementsYTHandler );
    } );
} )( jQuery );
*/