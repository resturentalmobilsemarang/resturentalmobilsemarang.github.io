...
(function ($) {
    ...
    var init_Scrollify = function ( ) {
        ...
        //sezioni = '.madxartwork-inner > .madxartwork-section-wrap > .madxartwork-section';
        //sezioni = '.madxartwork[data-madxartwork-type=post] > .madxartwork-inner > .madxartwork-section-wrap > .madxartwork-section';
        ...
        $target_sections = '.madxartwork-' + currentPostId; //settings_page.scroll_id_page;
        if (!$target_sections)
            $target_sections = '';

        sezioni = $target_sections + '.madxartwork > .madxartwork-inner > .madxartwork-section-wrap > .' + $customClass;
        wrapperSezioni = $($target_sections + '.madxartwork > .madxartwork-inner > .madxartwork-section-wrap');
        ...
        $.scrollify({
            ...
            afterRender: function () {
                is_scrollify = true;
                //
                //alert(Boolean(settings_page.enable_scrollify_nav) +' - '+ madxartworkFrontend.isEditMode());
    ...
    var init_InertiaScroll = function () {
        ...
        if ($('.madxartwork-template-canvas').length) {
            ...
            mainWrap = document.querySelector($target_sections + '.madxartwork > .madxartwork-inner > .madxartwork-section-wrap');
        } else {
        ...
        if (typeof madxartworkFrontendConfig.settings.page !== 'undefined') {
            ...
            if (madxartworkFrontend.isEditMode()) {
                if (madxartwork) {
                    ...
                    // madxartwork.settings.page.addChangeCallback( 'scroll_target', handleInertiaScroll );
