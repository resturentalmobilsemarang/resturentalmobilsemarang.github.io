...
( function( $ ) {
    ...
    var WooGalleryHandler = function ( $scope, $ ) {
        ...
        if(outer_wrapper.length) {
            ...
            var mswiper = new Swiper('.madxartwork-element-' + wid + ' .ae-swiper-container', adata);
        ...
        if($scope.find('.ae-post-widget-wrapper').hasClass('ae-carousel-yes')) {
            ...
            if(outer_wrapper.length) {
                ...
                if(pause_on_hover) {
                    ...
                    $('.madxartwork-element-' + wid + ' .ae-swiper-container').hover(function () {
    ...
    var ACFRepeaterTabsHandler = function( $scope, $ ) {
        ...
        $tabsTitles.on( 'click', function() {
            activateTab( this.dataset.tab );
            jQuery(".madxartwork-widget-ae-acf-repeater .swiper-container").each(function(elem, target) {
    ...
    var ACFRepeaterAccordionHandler = function ( $scope , $ ) {
        $title = $scope.find('.madxartwork-tab-title.ae-tab-title');
        $speed = $scope.find('ae-accordion').data('transition-speed');
        ($title).on('click',function (e) {
            e.preventDefault();
            var $this = $(this);
            if ($this.hasClass("madxartwork-active")) {
                $this.removeClass("madxartwork-active");
                ...
                $this
                    ...
                    .find(".ae-tab-content")
                    .slideUp($speed);
                $this.toggleClass("madxartwork-active");
